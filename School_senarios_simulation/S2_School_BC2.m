...
save S2_School_BC2_results
save('BC2_withSchoolOpen_ga.mat','new_infection_ga','-v6')
save('BC2_withSchoolOpen_gc.mat','new_infection_gc','-v6')
...
set(gca, 'Box', 'off', 'TickDir', 'out', 'TickLength', [.02 .02], ...
    ...
    'XColor', [.3 .3 .3], 'YColor', [.3 .3 .3], ...
    'LineWidth', 1)
print('-f4','-djpeg','-r600','./school_plot_revision/S2_School_BC2.jpeg')
saveas(gcf,'./school_plot_revision/S2_School_BC2.fig')
toc
