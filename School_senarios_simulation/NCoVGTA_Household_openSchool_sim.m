function xdot = NCoVGTA_Household_openSchool_sim(t,x,par1,par2,AC,CC)
% Adult population
...
%     c_R=CC(ch,8);
      ...
      if t<=T1
        Pdot_new=beta_q*(-ii*(kk+ll+mm+c_A+c_I1+c_I2)*P_ijklmxyzc-c_S*(kk+ll+mm)*P_ijklmxyzc+(ii+1)*(kk+ll+mm)* P_i1j_1klmxyzc)+...
                ...
                beta_sc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)*(-c_S*P_ijklmxyzc+P_ijkmxyzc_S1)+...
                beta_ga*(c_ga*(Aga+Iga1+Iga2)+c_ac*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)*(-ii*P_ijklmxyzc+(ii+1)* P_i1j_1klmxyzc);
      ...
      elseif t>T1 && ii==2 && c_S==1
          ...
          Pdot_new=beta_q*(-ii*(kk+ll+mm+c_A+c_I1+c_I2)*P_ijklmxyzc-c_S*(kk+ll+mm)*P_ijklmxyzc+(ii+1)*(kk+ll+mm)* P_i1j_1klmxyzc)+...
            ...
            Pdot_new_c=beta_q*(-c_S*(kk+ll+mm)*P_ijklmxyzc)+...
                 ...
                 1/tau2*P_ijkmxyzc_I1+theta_hc*P_ijkmxyzc_I2_H+theta_i*P_ijkmxyzc_I2_W+...
                 gamma_a*P_ijkmxyzc_A_R+gamma_m*P_ijkmxyzc_I2_R+...
                 beta_sc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)*(-c_S*P_ijklmxyzc+P_ijkmxyzc_S1)+gq+...
              ...
              Pdot_new=beta_q*(-ii*(kk+ll+mm+c_A+c_I1+c_I2)*P_ijklmxyzc-c_S*(kk+ll+mm)*P_ijklmxyzc+(ii+1)*(kk+ll+mm)* P_i1j_1klmxyzc)+...
                ...
                gamma_a*P_ijkmxyzc_A_R+gamma_m*P_ijkmxyzc_I2_R+...
                beta_sc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)*(-c_S*P_ijklmxyzc+P_ijkmxyzc_S1)+...
                beta_ga*(c_ga*(Aga+Iga1+Iga2)+c_ac*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)*(-ii*P_ijklmxyzc+(ii+1)* P_i1j_1klmxyzc)+gq;
             Pdot_new_c=beta_q*(-c_S*(kk+ll+mm)*P_ijklmxyzc)+...
                 1/tau1*(-c_E*P_ijklmxyzc)+1/tau2*(-c_I1*P_ijklmxyzc)+...
                 gamma_a*(-c_A*P_ijklmxyzc)+gamma_m*(-c_I2*P_ijklmxyzc)+...
                 theta_hc*(-c_I2*P_ijklmxyzc)+theta_i*(-c_I2*P_ijklmxyzc)+...
...
% end
if t<=T1
xdot=[-beta_ga*Sga*(c_ga*(Aga+Iga1+Iga2)+c_ac*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-Ega_temp;
      beta_ga*Sga*(c_ga*(Aga+Iga1+Iga2)+c_ac*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-1/tau1*Ega+Ega_temp;
      (1-a)/tau1*Ega-gamma_a*Aga;
      a/tau1*Ega-1/tau2*Iga1;
      1/tau2*Iga1-theta_ha*Iga2-theta_i*Iga2-gamma_m*Iga2-q_g2*Iga2;
      -beta_sc*Sgc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-Egc_temp;
      beta_sc*Sgc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-1/tau1*Egc+Egc_temp;
...
elseif t> T1 && schoolOpen==1
    xdot=[-beta_ga*Sga*(c_ga*(Aga+Iga1+Iga2)+c_ac*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-Ega_temp+2*gq*p_c*Sqa;
       beta_ga*Sga*(c_ga*(Aga+Iga1+Iga2)+c_ac*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-1/tau1*Ega+Ega_temp;
      (1-a)/tau1*Ega-gamma_a*Aga;
      a/tau1*Ega-1/tau2*Iga1;
      1/tau2*Iga1-theta_ha*Iga2-theta_i*Iga2-gamma_m*Iga2-q_g2*Iga2;
      -beta_sc*Sgc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-Egc_temp-beta_sc*c_sc*Ssc*(Asc+Isc1)/(Ssc+Esc+Asc+Isc1+Isc2)+gq*Sqc;
      beta_sc*Sgc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-1/tau1*Egc+Egc_temp+beta_sc*c_sc*Ssc*(Asc+Isc1)/(Ssc+Esc+Asc+Isc1+Isc2);
      (1-a)/tau1*Egc-gamma_a*Agc;
      a/tau1*Egc-1/tau2*Igc1;
      1/tau2*Igc1-theta_hc*Igc2-theta_i*Igc2-gamma_m*Igc2-q_g2*Igc2;
    ...
    xdot=[-beta_ga*Sga*(c_ga*(Aga+Iga1+Iga2)+c_ac*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-Ega_temp+2*gq*p_c*Sqa;
      ...
      a/tau1*Ega-1/tau2*Iga1;
      1/tau2*Iga1-theta_ha*Iga2-theta_i*Iga2-gamma_m*Iga2-q_g2*Iga2;
      -beta_sc*Sgc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-Egc_temp+gq*Sqc;
      beta_sc*Sgc*(c_ac*(Aga+Iga1+Iga2)+c_cc*(Agc+Igc1+Igc2))/(Sga+Ega+Aga+Iga1+Iga2+(Sgc+Egc+Agc+Igc1+Igc2)+H+W+R)-1/tau1*Egc+Egc_temp;
      (1-a)/tau1*Egc-gamma_a*Agc;
      a/tau1*Egc-1/tau2*Igc1;
      1/tau2*Igc1-theta_hc*Igc2-theta_i*Igc2-gamma_m*Igc2-q_g2*Igc2;
