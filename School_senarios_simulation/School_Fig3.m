...
Ia_output=[Ia_newt_total_schoolClose Ia_newt_total_Open_phase1 Ia_newt_total_schoolClose_Phase2...
          Ia_newt_total_Open_phase2 Ia_newt_total_schoolClose_Phase3 Ia_newt_total_Open_phase3...
          Ia_newt_total_schoolClose_Phase4 Ia_newt_total_Open_phase4 Inew_ga];
Ic_output=[Ic_newt_total_schoolClose Ic_newt_total_Open_phase1 Ic_newt_total_schoolClose_Phase2...
          Ic_newt_total_Open_phase2 Ic_newt_total_schoolClose_Phase3 Ic_newt_total_Open_phase3...
          Ic_newt_total_schoolClose_Phase4 Ic_newt_total_Open_phase4 Inew_gc];    
...
title('A')
legend([h1 h2 h3 h4 h5 h6 h7 h8 h9],'School close, phase 1', 'School open, phase 1','School close, phase 2','School open, phase 2','School close, phase 3','School open, phase 3','School close, phase 4','School open, phase 4','data','box','off','NumColumns',1)
xlim([1 95])
ylim([0 800])
xticks([1 40 67 95])
...
set(gca, 'Box', 'off', 'TickDir', 'out', 'TickLength', [.02 .02], ...
    ...
    'XColor', [.3 .3 .3], 'YColor', [.3 .3 .3], ...
    'LineWidth', 1)
% print('-f2','-djpeg','-r600','./School_plot_revision/School_Fig3_0518.jpeg')
