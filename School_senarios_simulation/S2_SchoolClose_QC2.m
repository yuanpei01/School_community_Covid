...
[t2,y2] = ode45(@NCoVGTA_Household_openSchool_sim,[T1:Num_fit],y01,[],par1_Open_2,par2,AC,CC); 
...
save S2_SchoolClose_QC2_results
save('QC2_withSchoolClose_ga.mat','new_infection_ga','-v6')
save('QC2_withSchoolClose_gc.mat','new_infection_gc','-v6')
...
set(gca, 'Box', 'off', 'TickDir', 'out', 'TickLength', [.02 .02], ...
    ...
    'XColor', [.3 .3 .3], 'YColor', [.3 .3 .3], ...
    'LineWidth', 1)
print('-f4','-djpeg','-r600','./school_plot_revision/S2_SchoolClose_QC2.jpeg')
saveas(gcf,'./school_plot_revision/S2_SchoolClose_QC2.fig')
toc
